...
const counterReducer = createReducer(
  ...
  on(binaryValueSuccess, (state: CounterState, { binaryValue }) => ({ ...state, binaryValue: binaryValue })),
  on(binaryValueError, (state: CounterState, { err }) => ({ ...state, val: 0, binaryValue: '0', err: err })),
);
